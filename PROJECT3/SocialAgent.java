...
public class SocialAgent extends Agent{
    ...
    /**
     * Constructs a social agent at a location specified by the super class Agent 
     * and with the specified radius.
     * 
     * @param x0 a double to specify the SocialAgent's x-position
     * @param y0 a double to specify the SocialAgent's y-position
     * @param radius an integer to specify the neighborly space of SocialAgent.
     */
    ...
    /**
     * Sets the current radius of SocialAgent to a new radius.
     * 
     * @param radius an integer to specify the neighborly space of SocialAgent.
     */
    ...
    /**
     * Returns the current radius of SocialAgent
     * 
     * @return SocialAgent's neighbor boundary.
     */
     ...
     * Draw the agent light blue if it moved during the last updateState
     * Otherwise, draw it dark blue.
     * 
    ...
    public void draw(Graphics g){
        ...
        else g.setColor(new Color(0, 0, 196));
    
        g.fillOval((int) getX(), (int) getY(), 5, 5);
    }

    /**
     * Calculates the number of neighbors that a SocialAgent has.
    ...
    public void updateState(Landscape scape){
        if (scape.getNeighbors(radius, radius, radius).size() < 4){
